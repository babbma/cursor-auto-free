    ...
    def __init__(self):
        ...
        self.translations = {
            "cn": {
                ...
                "complete_registration_manual": "3. 完整注册流程（手动）",
                "menu_full_registration": "1. 完整注册流程",
                "menu_batch_generate_accounts": "2. 批量生成账号",
                "menu_batch_full_registration": "3. 批量完整流程注册",
                "enter_option": "请输入选项 (1 或 2 或 3): ",
                "invalid_option": "无效的选项,请重新输入",
                "enter_valid_number": "请输入有效的数字",
                "enter_option_3": "请输入选项 (1 或 2 或 3): ",
                "enter_batch_count": "请输入批量数量: ",
                "feature_under_development": "功能开发中，敬请期待。",
                ...
                "cursor_account_info_full": "Cursor 账号信息:\n名字: {first_name}\t姓: {last_name}\n邮箱: {email}\n密码: {password}",
            ...
            "en": {
                ...
                "menu_full_registration": "1. Complete registration process",
                "menu_batch_generate_accounts": "2. Batch generate accounts",
                "menu_batch_full_registration": "3. Batch full registration process",
                "enter_option": "Please enter option (1 or 2): ",
                "enter_option_3": "Please enter option (1, 2, or 3): ",
                "invalid_option": "Invalid option, please enter again",
                "enter_valid_number": "Please enter a valid number",
                "enter_batch_count": "Please enter batch count: ",
